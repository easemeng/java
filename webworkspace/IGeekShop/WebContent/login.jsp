...
$(function(){
	$("#cd1").click(function(){
		...
		$.validator.addMethod(
			...
			function(value,element,params){
				...
				$.ajax({
					"async":false, // 同步操作
					"url":"${pageContext.request.contextPath}/CheckServlet?state=username",
					"type":"POST",
					"data":{"username":value},
					"dataType":"json",
	...
	$.validator.addMethod(
			...
			function(value,element,params){
				...
				$.ajax({
					"async":false,
					"url":"${pageContext.request.contextPath}/CheckServlet?state=code",
					"type":"POST",
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form action="${root}/CheckServlet?state=password" method="post" class="form-horizontal" id="loginForm">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									...
									<input type="checkbox" name="remember" value="off" onclick="re(this)"> 记住密码
									</label>
								</div>
							</div>
						</div>
