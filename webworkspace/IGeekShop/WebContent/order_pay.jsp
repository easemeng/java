...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${root}/product/ProductRelatedServlet?state=confirmPayment"
				method="post" style="margin-top: 5px; margin-left: 150px;">
				<input type="hidden" name="oid" value="${order.oid}" />
				<div class="form-group">
					<label for="adress" class="col-sm-1 control-label">地址</label>
					<div class="col-sm-5">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				...
				<p>
					<br /> <input type="radio" name="pd_FrpId" value="ICBC-NET-B2C"
						checked="checked" />工商银行 <img src="${root}/bank_img/icbc.bmp"
					...
					<input type="radio" name="pd_FrpId" value="ABC-NET-B2C" />农业银行 <img
						src="${root}/bank_img/abc.bmp" align="middle" /> <br /> <br /> <input
					...
					<input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />建设银行 <img
						src="${root}/bank_img/ccb.bmp" align="middle" /> <br /> <br /> <input
