...
<script type="text/javascript">
	function addCart(){
		...
		window.location="${root}/product/ProductRelatedServlet?state=addCart&pid=${product.pid}&quantity=" + qty;
	}
</script>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${root}/product/ProductRelatedServlet?state=index">首页&nbsp;&nbsp;&gt;</a> <a href="${root}/product/ProductRelatedServlet?state=productCgPage&page=1&cid=${category.cid}">${category.cname}&nbsp;&nbsp;&gt;</a>
				<a>${product.pname}</a>
			</div>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:void(0)" onclick="addCart()" id="addcart" > <input
								style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
								value="加入购物车" type="button">
							</a> &nbsp;收藏商品
						</div>
						<a href="${root}/product/ProductRelatedServlet?state=productCgPage&page=${currentPageNumber}&cid=${category.cid}" style="display: block; text-align: center" >返回商品列表</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
