...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/product/ProductServlet?state=addProduct" method="post" enctype="multipart/form-data">
			&nbsp;
