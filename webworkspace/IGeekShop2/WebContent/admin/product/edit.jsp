...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/product/ProductServlet?state=updateProduct&pid=${product.pid}&pimage=${product.pimage}" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="file" name="pimage" defaultValue="${product.pimage}" />
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						是否下架：
					</td>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="cid">
							<c:forEach items="${CategoryList}" var="category">
								<option value="${category.cid}" <c:if test="${product.cid==category.cid}">selected</c:if> >${category.cname}</option>
							</c:forEach>
