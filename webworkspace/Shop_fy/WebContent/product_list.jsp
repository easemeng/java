 ...
 -->
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			<li><a href="${root}/index/IndexServlet?state=page&page=1" aria-label="Previous"><span aria-hidden="true">首页</span></a></li>
			...
			<c:if test="${pageBean.currentPageNumber!=1}">
				<li ><a href="${root}/index/IndexServlet?state=page&page=${pageBean.currentPageNumber-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
			</c:if>
			
			<c:forEach begin="${pageBean.start}" end="${pageBean.end}" step="1" var="i">
				<li <c:if test="${pageBean.currentPageNumber==i}">class="active"</c:if> ><a href="${root}/index/IndexServlet?state=page&page=${i}">${i}</a></li>
			</c:forEach>
			...
			<c:if test="${pageBean.currentPageNumber!=pageBean.totalPage}">
				<li><a href="${root}/index/IndexServlet?state=page&page=${pageBean.currentPageNumber+1}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
			</c:if>
			...
			<li><a href="#">8</a></li>
			<li><a href="#">9</a></li> -->
			<li><a href="${root}/index/IndexServlet?state=page&page=${pageBean.totalPage}" aria-label="Next"><span aria-hidden="true">尾页</span></a></li>
		</ul>
	</div>
	<!-- 分页结束 -->
