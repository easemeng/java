...
<script type="text/javascript">
	function addProduct() {
		...
		window.location.href = "${root}/admin/AdminProductServlet?state=queryCategory";
	}
</script>
</HEAD>
<body>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${productList}" var="product">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<!-- product/edit.jsp -->
									<a href="${root}/admin/AdminProductServlet?state=edit&pid=${product.pid}">
											<img
											src="${pageContext.request.contextPath}/images/i_edit.gif"
											border="0" style="CURSOR: hand">
									</a></td>
									<!-- 超链接触发的删除请求 。 -->
									<td align="center" style="HEIGHT: 22px"><a href="${root}/admin/AdminProductServlet?state=delete&pid=${product.pid}"> <img
