			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProduct}" var="hotProduct">
						...
						<a href="product_info.htm">
							<img src="${root}/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="product_info.html" style='color:#666'>${hotProduct.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProduct}" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="product_info.htm">
							<img src="${root}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
