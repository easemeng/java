...
public class IOTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//输出流 。  注意  先抛出异常  。  注意：针对windows 操作系统 文件的分隔符  可以使 \\  也可以是  /
		// 针对 Linux操作系统   /
		FileWriter fw2 = new FileWriter("d:/hello.txt",true);//添加true表示不会覆盖原有内容。
		...
		//输出流 。  注意  先抛出异常  。  注意：针对windows 操作系统 文件的分隔符  可以使 \\  也可以是  /
		// 针对 Linux操作系统   /
		FileWriter fw3 = new FileWriter("d:/hello.txt",true);//添加true表示不会覆盖原有内容。
		...
		//输出流 。  注意  先抛出异常  。  注意：针对windows 操作系统 文件的分隔符  可以使 \\  也可以是  /
		// 针对 Linux操作系统   /
		FileWriter fw4 = new FileWriter("d:/hello.txt",true);//添加true表示不会覆盖原有内容。
		...
		//输出流 。  注意  先抛出异常  。  注意：针对windows 操作系统 文件的分隔符  可以使 \\  也可以是  /
		// 针对 Linux操作系统   /
		FileWriter fw5 = new FileWriter("d:/hello.txt",true);//添加true表示不会覆盖原有内容。
